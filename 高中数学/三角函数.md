- [三角函数](#三角函数)
  ...
  - [四、三角函数典型问题](#四三角函数典型问题)
    ...
    - [4.2 化简问题](#42-化简问题)
      - [4.2.1 整式降幂](#421-整式降幂)
      - [4.2.2 分式去1](#422-分式去1)
  - [五、解三角形 solving triangles](#五解三角形-solving-triangles)
    - [5.1 解三角形](#51-解三角形)
      - [5.1.1 正弦定理 law of sines](#511-正弦定理-law-of-sines)
      - [5.1.2 余弦定理 law of cosines](#512-余弦定理-law-of-cosines)
    - [5.2 三角形的六心](#52-三角形的六心)
      - [5.2.1 内心](#521-内心)
      - [5.2.2 外心](#522-外心)
      - [5.2.3 重心](#523-重心)
      - [5.2.4 垂心](#524-垂心)
...
3. 三个红色三角形顶点平方和为1
   ...
   $\sin^2+\cos^2 = 1, \tan^2+\sec^2=1, \cot^2+\csc^2=1$
...
1. 已知三边 $a\leqslant b \leqslant c$, 构成三角形的条件： $a+b \gt c$
