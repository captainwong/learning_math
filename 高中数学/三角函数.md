- [三角函数](#三角函数)
  - [1. 象限角的判断](#1-象限角的判断)
  - [2. 弧度制](#2-弧度制)
  - [3. 三角函数的图像与性质](#3-三角函数的图像与性质)
  - [4. 反三角函数的图像与性质](#4-反三角函数的图像与性质)
  - [5. 同角三角函数基本关系式](#5-同角三角函数基本关系式)
  - [6. 诱导公式](#6-诱导公式)
  - [7. 辅助角公式](#7-辅助角公式)
  - [8. 两角和差公式](#8-两角和差公式)
    - [8.1 两角差的余弦公式推导](#81-两角差的余弦公式推导)
    - [8.2 两角和的余弦公式推导](#82-两角和的余弦公式推导)
    - [8.3 两角和的正弦公式推导](#83-两角和的正弦公式推导)
    - [8.4 两角差的正弦公式推导](#84-两角差的正弦公式推导)
    - [8.5 两角和的正切公式推导](#85-两角和的正切公式推导)
    - [8.6 两角差的正切公式推导1](#86-两角差的正切公式推导1)
    - [8.7 两角差的正切公式推导2](#87-两角差的正切公式推导2)
  - [9. 二倍角公式](#9-二倍角公式)
    - [9.1 正弦二倍角公式推导](#91-正弦二倍角公式推导)
    - [9.2 余弦二倍角公式推导](#92-余弦二倍角公式推导)
    - [9.3 正切二倍角公式推导](#93-正切二倍角公式推导)
  - [10. 二倍角公式逆运算](#10-二倍角公式逆运算)
  - [11. 半角公式](#11-半角公式)
  - [12. 万能公式](#12-万能公式)
    - [12.1 正弦万能推导](#121-正弦万能推导)
    - [12.2 余弦万能推导](#122-余弦万能推导)
    - [12.3 正切万能推导1](#123-正切万能推导1)
    - [12.4 正切万能推导2](#124-正切万能推导2)
  - [13. 积化和差](#13-积化和差)
  - [14. 和差化积](#14-和差化积)
  - [参考](#参考)
...
1. 正弦函数 sine: $\sin \alpha = \frac y r$

    ![img](./img/sin.png)

    定义域 $\R$，值域 $[-1, 1]$，奇函数，周期 $2\pi$

2. 余弦函数 cosine: $\cos \alpha = \frac x r$
    
    ![img](./img/cos.png)

    定义域 $\R$，值域 $[-1,1]$，偶函数，周期 $2\pi$

3. 正切函数 tangent: $\tan \alpha = \frac y x$
    
    ![img](./img/tan.png)

    定义域 $\{x \in \R |x\ne k\pi + \frac \pi 2, k \in \Z\}$，值域 $\R$，奇函数，周期 $\pi$

4. 余切函数 cotangent: $\cot \alpha = \frac x y$
    
    ![img](./img/cot.png)

    定义域 $\{x\in \R| x \ne k\pi, k \in \Z\}$，值域 $\R$，奇函数，周期 $\pi$

5. 正割函数 secant: $\sec \alpha = \frac r x = \frac 1 {\cos \alpha}$
    
    ![img](./img/sec.png)

    定义域 $\{x\in \R| x\ne k\pi + \frac \pi 2, k \in \Z\}$，值域 $(-\infty, -1] \cup [1, +\infty)$，偶函数，周期 $2\pi$

6. 余割函数 cosecant: $\csc \alpha = \frac r y = \frac 1 {\sin \alpha}$
...
& = \frac{(2\sin{\frac\alpha 2}\cos{\frac\alpha 2}) / (\cos^2{\frac\alpha 2})}{(\sin^2{\frac \alpha 2} + \cos^2{\frac \alpha 2}) / (\cos^2{\frac\alpha 2})} \\
...
& = \frac{(\cos^2{\frac \alpha 2} - \sin^2{\frac\alpha 2}) / (\cos^2{\frac\alpha 2})}{(\sin^2{\frac\alpha 2} + \cos^2{\frac\alpha 2}) / (\cos^2{\frac\alpha 2})} \\
