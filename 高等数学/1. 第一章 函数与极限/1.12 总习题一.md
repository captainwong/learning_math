...
$|MK| \rightarrow 0(x\rightarrow -\infty) \implies |MK_1| \rightarrow 0(x\rightarrow -\infty)$，即
...
$$
\begin{align}
\lim\limits_{x\rightarrow -\infty}[f(x) - kx] & = \lim\limits_{x\rightarrow -\infty}[f(x) - (kx+b)] + b = 0+b = b, & ⑦ \\
\lim\limits_{x\rightarrow -\infty}\frac{f(x)}x & = \lim\limits_{x\rightarrow -\infty}\frac 1 x[f(x) - kx] + k = 0 + k = k & ⑧
\end{align}
$$
...
\begin{align}
\lim\limits_{x\rightarrow -\infty}f(x) & = b, & ⑨ \\
\lim\limits_{x\rightarrow -\infty}\frac{f(x)}x & = \lim\limits_{x\rightarrow -\infty}\frac 1 x \cdot \lim\limits_{x\rightarrow -\infty}f(x) = 0, & ⑩
\end{align}
$$

反之，若⑨、⑩成立，即有 $|MK|=|f(x)-b|\rightarrow 0(x\rightarrow -\infty)$，故 $y=b$ 是曲线 $y=f(x)$ 的水平渐近线.

综上，直线 $L:y=kx+b$ 为曲线 $y=f(x)$ 的渐近线的充分必要条件是
...
$$
\begin{align}
k &= \lim\limits_{x\rightarrow \infty}\frac{f(x)}x \\
& = \lim\limits_{x\rightarrow \infty}\frac{(2x-1)e^{\frac 1 x}}{x} \\
& = \lim\limits_{x\rightarrow \infty}(2-\frac 1 x)e^{\frac 1 x} \\
& = 2
\end{align}
$$
...
$$
\begin{align}
b & = \lim\limits_{x\rightarrow \infty}[f(x) - 2x] \\
& = \lim\limits_{x\rightarrow \infty}[(2x-1)e^{\frac 1 x} - 2x] \\
& = \lim\limits_{x\rightarrow \infty}(2x \cdot e^{\frac 1 x} - e^{\frac 1 x}-2x) \\
& = \lim\limits_{x\rightarrow \infty}2x(e^{\frac 1 x} - 1) - \lim\limits_{x\rightarrow \infty}e^{\frac 1 x} \\
& = \lim\limits_{x\rightarrow \infty}2x \cdot \frac 1 x - 1 \\
& = 1 
\end{align}
$$
