...
$k = \lim\limits_{x\rightarrow \infty}\frac{f(x)}x = \lim\limits_{x\rightarrow \infty}\frac{(2x-1)e^{\frac 1 x}}{x} = 2$

$$
\begin{align}
b = \lim\limits_{x\rightarrow \infty}[f(x) - 2x] & = \lim\limits_{x\rightarrow \infty}[(2x-1)e^{\frac 1 x} - 2x] \\
