- [第一章函数与极限习题课](#第一章函数与极限习题课)
  - [一、连续性问题](#一连续性问题)
    - [1.1 讨论函数 $f(x) = \lim\limits_{n\rightarrow \infty}\frac{1-x^{2n}}{1+x^{2n}}x$ 的连续性.](#11-讨论函数-fx--limlimits_nrightarrow-inftyfrac1-x2n1x2nx-的连续性)
    - [1.2 讨论 $f(x) = \frac 1{1-e^{\frac x{1-x}}}$ 的连续性](#12-讨论-fx--frac-11-efrac-x1-x-的连续性)
  - [二、求极限](#二求极限)
    - [2.1 求 $\lim\limits_{x\rightarrow 0}\frac{x^2\cos \sqrt{\sin x^2 + e^{\frac 1 x} + 1}}{1+x}$](#21-求-limlimits_xrightarrow-0fracx2cos-sqrtsin-x2--efrac-1-x--11x)
    - [2.2 求 $\lim\limits_{n\rightarrow \infty}n(e^\frac 1 n - 1)$](#22-求-limlimits_nrightarrow-inftynefrac-1-n---1)
    - [2.3 求 $\lim\limits_{x\rightarrow 0}\frac {\ln(1-2\sin x)} {3x}$](#23-求-limlimits_xrightarrow-0frac-ln1-2sin-x-3x)
    - [2.4 求 $\lim\limits_{x\rightarrow 0}(x^2\sin \frac 1 {x^2} + \frac{\sin 2x}x)$](#24-求-limlimits_xrightarrow-0x2sin-frac-1-x2--fracsin-2xx)
    - [2.5 求 $\lim\limits_{x\rightarrow \infty}x(\sqrt{1+\sin \frac 2 x} - 1)$](#25-求-limlimits_xrightarrow-inftyxsqrt1sin-frac-2-x---1)
    - [2.6 求 $\lim\limits_{x\rightarrow 0}(\frac{1+\tan x}{1+\sin x})^{\frac 1 {x^3}}$](#26-求-limlimits_xrightarrow-0frac1tan-x1sin-xfrac-1-x3)
    - [2.7 求 $\lim\limits_{x\rightarrow \frac \pi 4}(\tan x)^{\tan 2x}$](#27-求-limlimits_xrightarrow-frac-pi-4tan-xtan-2x)
    - [2.8 求 $\lim\limits_{n\rightarrow \infty}\frac{a^{\frac 1 n} - a^{\frac 1{n+1}}}{\frac 1 {n^2}}(a\gt 0)$](#28-求-limlimits_nrightarrow-inftyfracafrac-1-n---afrac-1n1frac-1-n2agt-0)
    - [2.9 设 $\lim\limits_{n\rightarrow \infty}\frac{n^\alpha}{n^\beta - (n-1)^\beta}=2010$，求 $\alpha, \beta$.](#29-设-limlimits_nrightarrow-inftyfracnalphanbeta---n-1beta2010求-alpha-beta)
    - [2.10 $\lim\limits_{x\rightarrow \infty}(\sqrt[3]{1+2x^2+x^3}-ax-b) = 0$, 求常数 $a, b$](#210-limlimits_xrightarrow-inftysqrt312x2x3-ax-b--0-求常数-a-b)
    - [2.11 求 $\lim\limits_{n\rightarrow \infty}(1+2^n+3^n)^{\frac 1 n}$](#211-求-limlimits_nrightarrow-infty12n3nfrac-1-n)
    - [2.12 求 $\lim\limits_{x\rightarrow 0}(\frac{2+e^{\frac 1 x}}{1+e^{\frac 2 x}} + \frac x {|x|})$](#212-求-limlimits_xrightarrow-0frac2efrac-1-x1efrac-2-x--frac-x-x)

# 第一章函数与极限习题课

## 一、连续性问题

### 1.1 讨论函数 $f(x) = \lim\limits_{n\rightarrow \infty}\frac{1-x^{2n}}{1+x^{2n}}x$ 的连续性.
...
### 1.2 讨论 $f(x) = \frac 1{1-e^{\frac x{1-x}}}$ 的连续性
...
### 2.1 求 $\lim\limits_{x\rightarrow 0}\frac{x^2\cos \sqrt{\sin x^2 + e^{\frac 1 x} + 1}}{1+x}$
...
### 2.2 求 $\lim\limits_{n\rightarrow \infty}n(e^\frac 1 n - 1)$
...
### 2.3 求 $\lim\limits_{x\rightarrow 0}\frac {\ln(1-2\sin x)} {3x}$
...
### 2.4 求 $\lim\limits_{x\rightarrow 0}(x^2\sin \frac 1 {x^2} + \frac{\sin 2x}x)$
...
### 2.5 求 $\lim\limits_{x\rightarrow \infty}x(\sqrt{1+\sin \frac 2 x} - 1)$
...
### 2.6 求 $\lim\limits_{x\rightarrow 0}(\frac{1+\tan x}{1+\sin x})^{\frac 1 {x^3}}$
...
### 2.7 求 $\lim\limits_{x\rightarrow \frac \pi 4}(\tan x)^{\tan 2x}$
...
### 2.8 求 $\lim\limits_{n\rightarrow \infty}\frac{a^{\frac 1 n} - a^{\frac 1{n+1}}}{\frac 1 {n^2}}(a\gt 0)$
...
### 2.9 设 $\lim\limits_{n\rightarrow \infty}\frac{n^\alpha}{n^\beta - (n-1)^\beta}=2010$，求 $\alpha, \beta$.
...
### 2.10 $\lim\limits_{x\rightarrow \infty}(\sqrt[3]{1+2x^2+x^3}-ax-b) = 0$, 求常数 $a, b$
...
### 2.11 求 $\lim\limits_{n\rightarrow \infty}(1+2^n+3^n)^{\frac 1 n}$

**解** 

$$
\begin{align}
\lim\limits_{n\rightarrow \infty}(1+2^n+3^n)^{\frac 1 n} & = \lim\limits_{n\rightarrow \infty} 3 \cdot (\frac 1 {3^n} + \frac {2^n} {3^n} + 1)^{\frac 1 n} \\
& = 3
\end{align}
$$

### 2.12 求 $\lim\limits_{x\rightarrow 0}(\frac{2+e^{\frac 1 x}}{1+e^{\frac 2 x}} + \frac x {|x|})$

**解** 

$$
\begin{align}
\lim\limits_{x\rightarrow 0^+}(\frac{2+e^{\frac 1 x}}{1+e^{\frac 2 x}} + \frac x {|x|}) & = \lim\limits_{x\rightarrow 0^+}(\frac{2e^{-\frac 1 x} + 1}{e^{-\frac 1 x} + e^{\frac 1 x}} + 1) = 1 \\
\lim\limits_{x\rightarrow 0^-}(\frac{2+e^{\frac 1 x}}{1+e^{\frac 2 x}} + \frac x {|x|}) & = \frac{2+0}{1+0} - 1 = 1 \\
\therefore \lim\limits_{x\rightarrow 0}(\frac{2+e^{\frac 1 x}}{1+e^{\frac 2 x}} + \frac x {|x|}) & = 1
\end{align}
$$