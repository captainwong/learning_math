...
1. 应用夹逼准则求极限，关键在放缩，需要 hin 强的技巧
    ...
    要用夹逼准则求 $\lim\limits_{n\rightarrow \infty}x_n$，就要找出 $y_n,z_n$，使得 $y_n \leqslant x_n \leqslant z_n$ 且 $\lim\limits_{n\rightarrow}y_n = \lim\limits_{n\rightarrow}z_n = A$，则 $\lim\limits_{n\rightarrow}x_n = A$

2. 对于 $y_n \lt x_n \lt z_n$，夹逼准则也可以应用
3. 夹逼准则对求“n项和的数列”的极限有奇效
