...
5. 根据函数极限或无穷大定义，填写下表：
    ...
    |-|---------------------|--------------------------|---------------------------|---------------------------|
    | $x\rightarrow x_0$ | $\forall \varepsilon \gt 0, \exists \delta \gt 0, \\ 使当 0\lt \|x-x_0\| \lt \delta 时，有 \|f(x)-A\|\lt \varepsilon$ | $\forall M \gt 0, \exists \delta \gt 0, 使当 0 \lt \|x-x_0\|\lt \delta 时，即有 \|f(x)\|\gt M$ | $\forall M \gt 0, \exists \delta \gt 0, 使当 0 \lt \|x-x_0\|\lt \delta 时，即有 f(x)\gt M$ | $\forall M \gt 0, \exists \delta \gt 0, 使当 0 \lt \|x-x_0\|\lt \delta 时，即有 f(x)\lt -M$ |
