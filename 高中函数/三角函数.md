...
$$
\begin{align}
\sin(\alpha \pm \beta) & = \sin \alpha \cdot \cos \beta \pm \cos \alpha \cdot \sin \beta \implies \\
\sin\alpha\cos\beta & = \frac{\sin(\alpha+\beta)+\sin(\alpha-\beta)} 2 ① \\
\cos\alpha\sin\beta & = \frac{\sin(\alpha+\beta)-\sin(\alpha-\beta)}2 ② \\
\cos(\alpha \pm \beta) & = \cos \alpha \cdot \cos \beta \mp \sin \alpha \cdot \sin \beta \implies \\
