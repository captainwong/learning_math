...
|-|---------------------|--------------------------|---------------------------|---------------------------|
| $x\rightarrow x_0$ | $\forall \varepsilon \gt 0, \exists \delta \gt 0, 使当 0\lt \|x-x_0\| \lt \delta 时，即有 \|f(x)-A\|\lt \varepsilon$ |
| $x\rightarrow x_0^+$ | $\forall \varepsilon \gt 0, \exists \delta \gt 0, 使当 0\lt x-x_0 \lt \delta 时，即有 \|f(x)-A\|\lt \varepsilon$ |
| $x\rightarrow x_0^-$ | $\forall \varepsilon \gt 0, \exists \delta \gt 0, 使当 0\lt x_0-x \lt \delta 时，即有 \|f(x)-A\|\lt \varepsilon$ |
| $x\rightarrow \infty$ | $\forall \varepsilon \gt 0, \exists X \gt 0, 使当 \| x \|\gt X 时，即有 \|f(x)-A\|\lt \varepsilon$ |
| $x\rightarrow +\infty$ | $\forall \varepsilon \gt 0, \exists X \gt 0, 使当 x \gt X 时，即有 \|f(x)-A\|\lt \varepsilon$ |
| $x\rightarrow -\infty$ | $\forall \varepsilon \gt 0, \exists X \gt 0, 使当 x \lt -X 时，即有 \|f(x)-A\|\lt \varepsilon$ |